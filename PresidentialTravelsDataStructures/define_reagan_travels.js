const arcs1981 = [
  ...
  },
  {
    startLat: 38.9072, // Washington, DC, USA
    startLng: -77.0369,
    endLat: 21.1527467,  // Cancun, Mexico
    endLng: -86.8425761
  },
  {
    startLat: 21.1527467, // Cancun, Mexico
    startLng: -86.8425761,
    endLat: 38.9072,  // Washington, DC, USA
    endLng: -77.0369
  },
...
const cities1981 = [
  ...
  { lat: 21.1527467, lng: -86.8425761, name: "Cancun" },
...
const arcs1982 = [
  ...
  },
  {
    ...
    startLng: 2.320041,
    endLat: 48.8035403,  // Versailles, France
    endLng: 2.1266886
  },
  {
    startLat: 48.8035403, // Versailles, France
    startLng: 2.1266886,
  ...
  },
  {
    ...
    startLng: 7.2605602,
    endLat: 52.5601976,  // West Berlin, West Germany
    endLng: 12.9823712
  },
  {
    startLat: 52.5601976, // West Berlin, West Germany
    startLng: 12.9823712,
    endLat: 38.9072,  // Washington, DC, USA
    endLng: -77.0369
  },
  {
    startLat: 38.9072, // Washington, DC, USA
    startLng: -77.0369,
    endLat: 32.5317397,  // Tijuana, Mexico
    endLng: -117.019529
  },
  {
    startLat: 32.5317397, // Tijuana, Mexico
    startLng: -117.019529,
    endLat: 38.9072,  // Washington, DC, USA
    endLng: -77.0369
  },
  ...
  },
  {
    ...
    startLng: -46.6333824,
    endLat: 4.711011,  // Bogota, Colombia
    endLng: -74.0720917
  },
  {
    startLat: 4.711011, // Bogota, Colombia
    startLng: -74.0720917,
  ...
  },
  {
    ...
    startLng: -84.0795782,
    endLat: 15.5062156,  // San Pedro Sula, Honduras
    endLng: -88.0248937
  },
  {
    startLat: 15.5062156, // San Pedro Sula, Honduras
    startLng: -88.0248937,
    endLat: 38.9072,  // Washington, DC, USA
    endLng: -77.0369
  },
...
const cities1982 = [
  ...
  { lat: 32.5317397, lng: -117.019529, name: "Tijuana" },
  { lat: 48.8588897, lng: 2.320041, name: "Paris" },
  { lat: 15.5062156, lng: -88.0248937, name: "San Pedro Sula" },
...
const arcs1983 = [
  {
    startLat: 38.9072, // Washington, DC, USA
    startLng: -77.0369,
    endLat: 24.1619948,  // La Paz, Mexico
    endLng: -110.3158532
  },
  {
    startLat: 24.1619948, // La Paz, Mexico
    startLng: -110.3158532,
    endLat: 38.9072,  // Washington, DC, USA
    endLng: -77.0369
  },
  {
  ...
  },
  {
    ...
    endLat: 38.2336866,  // Demilitarized Zone, South Korea
    endLng: 127.0087307
  },
  {
    startLat: 38.2336866, // Demilitarized Zone, South Korea
...
const cities1983 = [
  ...
  { lat: 24.1619948, lng: -110.3158532, name: "La Paz" },
  { lat: 38.2336866, lng: 127.0087307, name: "Demilitarized Zone" },
];
...
const arcs1984 = [
  ...
  },
  {
    ...
    startLng: -8.1611027,
    endLat: 53.2744122,  // Galway, Ireland
    endLng: -9.0490601
  },
  {
    startLat: 53.2744122, // Galway, Ireland
    startLng: -9.0490601,
    endLat: 52.2486117,  // Ballyporeen, Ireland
    endLng: -8.118903
  },
  {
    startLat: 52.2486117, // Ballyporeen, Ireland
    startLng: -8.118903,
...
const cities1984 = [
  ...
  { lat: 38.9072, lng: -77.0369, name: "Washington, DC" },
  { lat: 52.2486117, lng: -8.118903, name: "Ballyporeen" },
  { lat: 49.0677708, lng: 0.3138532, name: "Normandy" },
  { lat: 53.2744122, lng: -9.0490601, name: "Galway" },
...
const arcs1985 = [
  ...
  },
  {
    startLat: 50.7842863, // Bonn, West Germany
    startLng: 7.2605602,
    endLat: 52.75869,  // Bergen-Belsen, West Germany
    endLng: 9.90657
  },
  {
    startLat: 52.75869, // Bergen-Belsen, West Germany
    startLng: 9.90657,
    endLat: 49.96794,  // Bitburg, West Germany
    endLng: 6.52734
  },
  {
...
const arcs1986 = [
  {
    startLat: 38.9072, // Washington, DC, USA
    startLng: -77.0369,
    endLat: 32.6405247,  // Mexicali, Mexico
    endLng: -115.474899
  },
  {
    startLat: 32.6405247, // Mexicali, Mexico
    startLng: -115.474899,
    endLat: 38.9072,  // Washington, DC, USA
    endLng: -77.0369
  },
  {
    startLat: 38.9072, // Washington, DC, USA
    startLng: -77.0369,
    endLat: 12.0535331,  // St. George's, Grenada
    endLng: -61.751805
  },
  {
    startLat: 12.0535331, // St. George's, Grenada
    startLng: -61.751805,
    endLat: 38.9072,  // Washington, DC, USA
    endLng: -77.0369
  },
  ...
  },
  {
    startLat: 38.9072, // Washington, DC, USA
    startLng: -77.0369,
    endLat: 64.145981,  // Reykjavík, Iceland
    endLng: -21.9422367
  },
  {
    startLat: 64.145981, // Reykjavík, Iceland
    startLng: -21.9422367,
    endLat: 38.9072,  // Washington, DC, USA
    endLng: -77.0369
  },
...
const cities1986 = [
  { lat: 35.6768601, lng: 139.7638947, name: "Tokyo" },
  { lat: 38.9072, lng: -77.0369, name: "Washington, DC" },
  { lat: 64.145981, lng: -21.9422367, name: "Reykjavík" },
  { lat: -8.2271303, lng: 115.1919203, name: "Bali" },
  { lat: 32.6405247, lng: -115.474899, name: "Mexicali" },
  { lat: 12.0535331, lng: -61.751805, name: "St. George's" },
];
...
const arcs1987 = [
  ...
  },
  {
    startLat: 38.9072, // Washington, DC, USA
    startLng: -77.0369,
    endLat: 45.4371908,  // Venice, Italy
    endLng: 12.3345898
  },
  {
    startLat: 45.4371908, // Venice, Italy
    startLng: 12.3345898,
    endLat: 41.8933203,  // Rome, Italy
    endLng: 12.4829321
  },
...
const cities1987 = [
  ...
  { lat: 38.9072, lng: -77.0369, name: "Washington, DC" },
  { lat: 41.9032459, lng: 12.4551867, name: "Apostolic Palace" },
  { lat: 45.4371908, lng: 12.3345898, name: "Venice" },
  { lat: 41.8933203, lng: 12.4829321, name: "Rome" },
  { lat: 52.5601976, lng: 12.9823712, name: "West Berlin" },
  { lat: 50.7842863, lng: 7.2605602, name: "Bonn" },
];
...
const arcs1988 = [
  {
    startLat: 38.9072, // Washington, DC, USA
    startLng: -77.0369,
    endLat: 23.2035785,  // Mazatlan, Mexico
    endLng: -106.4208391
  },
  {
    startLat: 23.2035785, // Mazatlan, Mexico
    startLng: -106.4208391,
    endLat: 38.9072,  // Washington, DC, USA
    endLng: -77.0369
  },
  {
  ...
  },
  {
    ...
    startLng: 24.9427473,
    endLat: 55.7544215,  // Moscow, Soviet Union
    endLng: 37.6126513
  },
  {
    startLat: 55.7544215, // Moscow, Soviet Union
    startLng: 37.6126513,
    endLat: 51.5074456,  // London, United Kingdom
    endLng: -0.1277653
  },
...
const cities1988 = [
  { lat: 23.2035785, lng: -106.4208391, name: "Mazatlan" },
  { lat: 60.1674881, lng: 24.9427473, name: "Helsinki" },
  { lat: 38.9072, lng: -77.0369, name: "Washington, DC" },
  { lat: 51.5074456, lng: -0.1277653, name: "London" },
  { lat: 50.8465573, lng: 4.351697, name: "Brussels" },
  { lat: 43.6534817, lng: -79.3839347, name: "Toronto" },
  { lat: 55.7544215, lng: 37.6126513, name: "Moscow" },
];

export const labelsDefaultCities = [...cities1981, ...cities1982, ...cities1983, ...cities1984, ...cities1985, ...cities1986, ...cities1987, ...cities1988];
