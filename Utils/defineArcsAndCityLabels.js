...
const labels2025RoadTripCities = [
  ...
  { lat: 38.6270, lng: -90.1994, name: "St. Louis", size: 1},
  { lat: 39.9612, lng: -82.9988, name: "Columbus", size: 1.2 },
  { lat: 40.4406, lng: -79.9959, name: "Pittsburgh", size: 1 },
...
const datasets = {
  ...
  "2025 Road Trip": {
    ...
    view: { lat: 39.0997, lng: -94.5786, altitude: 1.5 } // Kansas City Coords
  },
  "2025 Alaska Cruise": {
    arcs: arcsAlaskaTrip,
