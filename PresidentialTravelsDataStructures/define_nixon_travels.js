const arcs1969 = [
  ...
  },
  {
    ...
    endLat: 10.8103017,  // Saigon, South Vietnam
    endLng: 106.7576966
  },
  {
    startLat: 10.8103017, // Saigon, South Vietnam
    startLng: 106.7576966,
    endLat: 19.1774437,  // Di An, South Vietnam
    endLng: 105.630582
  },
  {
    startLat: 19.1774437, // Di An, South Vietnam
    startLng: 105.630582,
  ...
  },
  {
    ...
    startLng: 77.2192671,
    endLat: 31.5656822,  // Lahore, Pakistan
    endLng: 74.3141829
  },
  {
    startLat: 31.5656822, // Lahore, Pakistan
    startLng: 74.3141829,
...
const cities1969 = [
  ...
  { lat: 19.1774437, lng: 105.630582, name: "Di An" },
  { lat: 31.5656822, lng: 74.3141829, name: "Lahore" },
...
const arcs1970 = [
  {
    startLat: 38.9072, // Washington, DC, USA
    startLng: -77.0369,
    endLat: 20.6407176,  // Puerto Vallarta, Mexico
    endLng: -105.220306
  },
  {
    startLat: 20.6407176, // Puerto Vallarta, Mexico
    startLng: -105.220306,
    endLat: 38.9072,  // Washington, DC, USA
    endLng: -77.0369
  },
  ...
  },
  {
    ...
    startLng: -8.6301239,
    endLat: 52.9611523,  // Timahoe, Ireland
    endLng: -7.2017883
  },
  {
    startLat: 52.9611523, // Timahoe, Ireland
    startLng: -7.2017883,
...
const cities1970 = [
  { lat: 52.9611523, lng: -7.2017883, name: "Timahoe" },
  { lat: 41.8933203, lng: 12.4829321, name: "Rome" },
  ...
  { lat: 38.9072, lng: -77.0369, name: "Washington, DC" },
  { lat: 20.6407176, lng: -105.220306, name: "Puerto Vallarta" },
...
const arcs1972 = [
  ...
  },
  {
    startLat: 38.9072, // Washington, DC, USA
    startLng: -77.0369,
    endLat: 47.7981346,  // Salzburg, Austria
    endLng: 13.0464806
  },
  {
...
const arcs1974 = [
  ...
  },
  {
    ...
    startLng: 29.8951716,
    endLat: 21.5504432,  // Jedda, Saudi Arabia
    endLng: 39.1742363
  },
  {
    startLat: 21.5504432, // Jedda, Saudi Arabia
    startLng: 39.1742363,
...
export const labelsDefaultCities = [...cities1969, ...cities1970, ...cities1971, ...cities1972, ...cities1973, ...cities1974];
