...
const arcs1966 = [
  ...
  },
  {
    ...
    startLng: -66.9193702,
    endLat: 45.1267035,  // Chamcook, Canada
    endLng: -67.0713173
  },
  {
    startLat: 45.1267035, // Chamcook, Canada
    startLng: -67.0713173,
    endLat: 38.9072,  // Washington, DC, USA
    endLng: -77.0369
  },
  {
    startLat: 38.9072, // Washington, DC, USA
    startLng: -77.0369,
    endLat: -41.2887953,  // Wellington, New Zealand
    endLng: 174.7772114
  },
  {
    startLat: -41.2887953, // Wellington, New Zealand
    startLng: 174.7772114,
  ...
  },
  {
    ...
    endLat: -19.2569391,  // Townsville, Australia
    endLng: 146.8239537
  },
  {
    startLat: -19.2569391, // Townsville, Australia
    startLng: 146.8239537,
  ...
  },
  {
    ...
    endLat: 14.1775648,  // Los Baños, Philippines
    endLng: 121.2214303
  },
  {
    startLat: 14.1775648, // Los Baños, Philippines
    startLng: 121.2214303,
    endLat: 9.6928384,  // Corregidor, Philippines
    endLng: 126.0774192
  },
  {
    startLat: 9.6928384, // Corregidor, Philippines
    startLng: 126.0774192,
    endLat: 11.0,  // Cam Ranh Bay, South Vietnam
    endLng: 107.0
  },
  {
    startLat: 11.0, // Cam Ranh Bay, South Vietnam
    startLng: 107.0,
  ...
  },
  {
    ...
    endLat: 37.2633325,  // Suwon, South Korea
    endLng: 127.0287472
  },
  {
    startLat: 37.2633325, // Suwon, South Korea
    startLng: 127.0287472,
    endLat: 38.9072,  // Washington, DC, USA
    endLng: -77.0369
  },
  {
    startLat: 38.9072, // Washington, DC, USA
    startLng: -77.0369,
    endLat: 29.3248796,  // Ciudad Acuña, Mexico
    endLng: -100.9322287
  },
  {
    startLat: 29.3248796, // Ciudad Acuña, Mexico
    startLng: -100.9322287,
    endLat: 38.9072,  // Washington, DC, USA
    endLng: -77.0369
  },
];
...
const cities1966 = [
  ...
  { lat: 29.3248796, lng: -100.9322287, name: "Ciudad Acuña" },
  { lat: 37.2633325, lng: 127.0287472, name: "Suwon" },
  { lat: -19.2569391, lng: 146.8239537, name: "Townsville" },
  { lat: 38.9072, lng: -77.0369, name: "Washington, DC" },
...
const arcs1967 = [
  {
    startLat: 38.9072, // Washington, DC, USA
    startLng: -77.0369,
    endLat: -34.9632342,  // Punta del Este, Uruguay
    endLng: -54.9439981
  },
  {
    startLat: -34.9632342, // Punta del Este, Uruguay
    startLng: -54.9439981,
    endLat: 5.8241764,  // Paramaribo, Suriname
    endLng: -55.1662813
  },
  {
    startLat: 5.8241764, // Paramaribo, Suriname
    startLng: -55.1662813,
    endLat: 38.9072,  // Washington, DC, USA
    endLng: -77.0369
  },
  ...
  },
  {
    startLat: 38.9072, // Washington, DC, USA
    startLng: -77.0369,
    endLat: 45.5031824,  // Montreal, Canada
    endLng: -73.5698065
  },
  {
    startLat: 45.5031824, // Montreal, Canada
    startLng: -73.5698065,
  ...
  },
  {
    startLat: -37.8142454, // Melbourne, Australia
    startLng: 144.9631732,
    endLat: 14.9747339,  // Khorat, Thailand
    endLng: 102.0981161
  },
  {
    startLat: 14.9747339, // Khorat, Thailand
    startLng: 102.0981161,
    endLat: 11.0,  // Cam Ranh Bay, South Vietnam
    endLng: 107.0
  },
  {
    startLat: 11.0, // Cam Ranh Bay, South Vietnam
    startLng: 107.0,
    endLat: 24.8546842,  // Karachi, Pakistan
    endLng: 67.0207055
  },
  {
    startLat: 24.8546842, // Karachi, Pakistan
    startLng: 67.0207055,
...
const cities1967 = [
  { lat: 38.9072, lng: -77.0369, name: "Washington, DC" },
  { lat: -37.8142454, lng: 144.9631732, name: "Melbourne" },
  { lat: -34.9632342, lng: -54.9439981, name: "Punta del Este" },
  { lat: 11.0, lng: 107.0, name: "Cam Ranh Bay" },
  { lat: 41.8933203, lng: 12.4829321, name: "Rome" },
  { lat: 50.7842863, lng: 7.2605602, name: "Bonn" },
  { lat: 45.5031824, lng: -73.5698065, name: "Montreal" },
  { lat: -35.2975906, lng: 149.1012676, name: "Canberra" },
  { lat: 5.8241764, lng: -55.1662813, name: "Paramaribo" },
  { lat: 24.8546842, lng: 67.0207055, name: "Karachi" },
  { lat: 14.9747339, lng: 102.0981161, name: "Khorat" },
...
export const labelsDefaultCities = [...cities1964, ...cities1966, ...cities1967, ...cities1968];
